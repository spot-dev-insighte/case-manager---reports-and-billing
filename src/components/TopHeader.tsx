...
export function TopHeader({ onMenuClick, onNavigate }: TopHeaderProps) {
  return (
    <header className="bg-white border-b border-slate-200 px-4 md:px-8 py-4 flex items-end justify-between shrink-0">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        {/* Actions removed per user request to simplify UI */}
      </div>
    </header>
  );
}
